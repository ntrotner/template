...
export class LoginFixture {
	...
	public clickLogin(): Promise<void> {
		return this.page.locator("button", { has: this.page.locator('text="Login"') }).click();
	}

	public clickRegister(): Promise<void> {
		return this.page.locator("button", { has: this.page.locator('text="Register"') }).click();
	}

	public clickSubmitRegister(): Promise<void> {
		return this.page.locator("div[aria-labelledby=register] div.submit button").click();
	}
