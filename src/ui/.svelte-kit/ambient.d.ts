...
declare module '$env/static/private' {
	...
	export const COUCHDB_PASSWORD: string;
	...
	export const VITE_sharedConfig: string;
	...
	export const sharedConfig: string;
	export const COUCHDB_USER: string;
	...
	export const DISABLE_IPV6: string;
